	...
	<div class="container">
		...
		<?php echo form_open('RegCustCont/regCust'); ?>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="Input name" placeholder="eg: Nimal" name ="fnm">
				</div>
				<div class="form-group">
					<label for="exampleInputEmail1">Last name: </label>
					<input type="text" class="form-control" id="Input name" placeholder="eg: Perera" name="lnm">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="input contact" placeholder="07X-XXXXXXX" name="cntct">			    
				</div>
				<div class="form-group">
